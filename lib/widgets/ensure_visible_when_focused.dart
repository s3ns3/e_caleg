...
// based on https://www.didierboelens.com/2018/04/hint-4-ensure-a-textfield-or-textformfield-is-visible-in-the-viewport-when-has-the-focus/
...
//    if (position.pixels > double.tryParse("${viewport.getOffsetToReveal(object, 0.0)}").toDouble()) {
